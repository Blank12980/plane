...
export function LinkEditView({ viewProps }: LinkEditViewProps) {
  ...
  return (
    <div
      ...
      tabIndex={0}
    >
      <InputView label="URL" placeholder="Вставьте или введите URL" value={localUrl} onChange={setLocalUrl} autoFocus />
      <InputView label="Текст" placeholder="Текст ссылки" value={localText} onChange={handleTextChange} />
