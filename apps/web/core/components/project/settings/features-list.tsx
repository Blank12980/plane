...
const PROJECT_FEATURES_LIST = {
  cycles: {
    ...
    property: "cycle_view",
    title: "Циклы",
    description: "Разбивайте работу на отрезки времени и меняйте частоту от периода к периоду.",
  ...
  modules: {
    ...
    title: "Модули",
    description: "Группируйте работу в подпроекты со своими лидами и исполнителями.",
  ...
  views: {
    ...
    title: "Представления",
    description: "Сохраняйте сортировку, фильтры и отображение или делитесь ими.",
  ...
  pages: {
    ...
    property: "page_view",
    title: "Страницы",
    description: "Пишите документацию, заметки и всё, что нужно команде.",
  ...
  inbox: {
    ...
    property: "inbox_view",
    title: "Предложения",
    description: "Обсуждайте рабочие элементы до того, как добавить их в проект.",
